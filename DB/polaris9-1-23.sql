...
--
-- Host: localhost
-- Generation Time: Sep 01, 2023 at 09:41 AM
...
--
-- Table structure for table `user_status_LU`
--
...
--
-- Dumping data for table `user_status_LU`
--

INSERT INTO `user_status_LU` (`id`, `status`) VALUES
(1, 'OK'),
(2, 'Locked'),
(3, 'New');
...
--
-- Table structure for table `user_type_LU`
--

CREATE TABLE `user_type_LU` (
  `id` int(11) NOT NULL,
  `type` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `user_type_LU`
--

INSERT INTO `user_type_LU` (`id`, `type`) VALUES
(1, 'User'),
(2, 'Administrator'),
(3, 'Pending');
...
--
-- Indexes for table `user_status_LU`
--
ALTER TABLE `user_status_LU`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_type_LU`
--
ALTER TABLE `user_type_LU`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `user_status_LU`
--
ALTER TABLE `user_status_LU`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `user_type_LU`
--
ALTER TABLE `user_type_LU`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
